...
export const timeTrackingService = {
  async startTimer(taskId, description = null) {
   ...
   * @returns {Promise<Object>} Created time entry
   */
  async createManualEntry(taskId, startTime, endTime, description = null) {
    const user = await authUtils.getCurrentUser();
   ...
   * @returns {Promise<number>} Total seconds
   */
  async getUserTotalTime(startDate = null, endDate = null) {
    const user = await authUtils.getCurrentUser();
   ...
   */
  subscribeToTaskTimeEntries(taskId, callback) {
   ...
   * @returns {Object} Subscription object with unsubscribe method
   */
  async subscribeToActiveTimer(callback) {
    const user = await authUtils.getCurrentUser();
