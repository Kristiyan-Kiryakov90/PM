...
export const uiHelpers = {
   ...
   */
  showError(message, containerId = null, timeout = 5000) {
   ...
   * @param {number} timeout - Auto-dismiss timeout in ms (0 = no auto-dismiss)
   */
  showSuccess(message, containerId = null, timeout = 3000) {
    const alertId = 'alert-' + Date.now();
    const alertHTML = `
   ...
   * @param {number} timeout - Auto-dismiss timeout in ms (0 = no auto-dismiss)
   */
  showInfo(message, containerId = null, timeout = 4000) {
    const alertId = 'alert-' + Date.now();
    const alertHTML = `
   ...
   * @param {number} timeout - Auto-dismiss timeout in ms (0 = no auto-dismiss)
   */
  showWarning(message, containerId = null, timeout = 4000) {
    const alertId = 'alert-' + Date.now();
    const alertHTML = `
   ...
   */
  showFormErrors(errors, containerId = null) {
