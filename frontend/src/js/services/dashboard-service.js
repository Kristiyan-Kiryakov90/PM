...
export async function getDashboardStats() {
  try {
    ...
    const [projectsResult, tasksResult, completedThisWeekResult, overdueResult] = await Promise.all([
      getProjectCount(companyId, userId),
      getTaskCount(companyId, userId),
      getCompletedThisWeekCount(companyId, userId),
      getOverdueTaskCount(companyId, userId),
    ]);
 ...
 */
async function getProjectCount(companyId, userId) {
  let query = supabase
    .from('projects')
 ...
 */
async function getTaskCount(companyId, userId) {
  let query = supabase
    .from('tasks')
    .select('id', { count: 'exact', head: true })
 ...
 */
async function getCompletedThisWeekCount(companyId, userId) {
 ...
 */
async function getOverdueTaskCount(companyId, userId) {
