 ...
 */
export async function getProjectStatuses(projectId) {
  try {
 ...
 * @returns {Promise<void>}
 */
export async function reorderStatuses(projectId, statusOrders) {
  try {
 ...
 */
export async function getDefaultStatus(projectId) {
  try {
    const { data, error } = await supabase
      .from('status_definitions')
      .select('*')
 ...
 * @returns {Promise<void>}
 */
export async function setDefaultStatus(projectId, statusId) {
  try {
 ...
 */
export async function getStatusesWithTaskCounts(projectId) {
  try {
    const statuses = await getProjectStatuses(projectId);
